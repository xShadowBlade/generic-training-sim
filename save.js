Game.dataManagement = (function () {
    ...
    const saveData = function () {
        ...
        Game["data"].chronos.timeLastPlayed = E(Date.now());
    ...
    const loadData = function () {
        ...
        // Process the object
        let loadedData = decompileData();
        loadedData = processObject(loadedData)
        ...
        deepMerge(normalData, loadedData)
    ...
    return { resetData, compileData, decompileData, saveData, exportData, loadData, normalData }
})();